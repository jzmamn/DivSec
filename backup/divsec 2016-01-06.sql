...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 05, 2016 at 08:51 PM
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='details about the request submitted by the public individual' AUTO_INCREMENT=9 ;
...
(7, 4, 2, 1, '2016-01-04 00:00:00', 'Nice test', '1200.00', 23, 1, 1, b'0', b'0', b'0'),
(8, 4, 2, 1, '2016-01-05 00:00:00', '', '1200.00', 23, 1, 2, b'0', b'0', b'0');
...
`rl_ent_date`)
VALUES
(OLD.`req_id`,now(),OLD.`req_status_id`,OLD.`req_user_id`,OLD.`req_note`, OLD.`req_ent_date`);
END
//
DELIMITER ;
...
INSERT INTO `request_log` (`rl_id`, `rl_pr_id`, `rl_txn_date`, `rl_status_id`, `rl_user_id`, `rl_note`, `rl_ent_date`) VALUES
(1, 8, '2016-01-05 23:00:09', 1, 23, '', '2016-01-05 00:00:00');
