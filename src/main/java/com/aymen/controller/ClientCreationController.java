...
public class ClientCreationController {
    ...
    private static final Logger logger = LoggerFactory.getLogger(ClientCreationController.class);
    ...
    public String init(@ModelAttribute("maStaff") Staff staff, ModelMap model) {
        ...
        model.addAttribute("stfPiId", stf.getStfPiId());
        model.addAttribute("userName", getPrincipal());
        model.addAttribute("role", getUserRole());
        model.addAttribute("cmdUserCreation", new Staff());

        return "setup/clientregistration";
    }
    ...
    List<Object> getData() {
        ...
        return this.userCreationsSVC.getStaffByUserRoleSvc("ROLE_CLIENT");
    }
    ...
    public @ResponseBody
    String deleteStaff(@ModelAttribute("maStaff") Staff staff, BindingResult result,
    ...
    public @ResponseBody
    String getStaffDropdown(Model model)
