...
@Controller
@RequestMapping(value = "/rptemaillog")
public class RptEmailLog {

    private static final Logger logger = LoggerFactory.getLogger(RptEmailLog.class);
    ...
    public String home(ModelMap model) {
        ...
        return "reports/trail/rpt_email_log";
    }

    @RequestMapping(value = "/list-email-log", method = RequestMethod.GET)
    public @ResponseBody
    List<Object> listEmailLog(ModelMap model) {
        return reqSvc.listEmailLogSvc();
    }
