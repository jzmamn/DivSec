        ...
        <div id="wrap">
            ...
            <div id="content">
                ...
                <div class="inner" style="min-height: 700px;">
                    <div class="row">
                        <div class="col-lg-12">
                            <h3 class="text-info">Staff Home Page - ${stfDivName}</h3>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div style="text-align: center;">
                                ...
                                </a> <a class="quick-btn" href="${pageContext.request.contextPath}/rptrequest"> <i class="icon-bar-chart icon-2x"></i> <span>RequestReport</span>
