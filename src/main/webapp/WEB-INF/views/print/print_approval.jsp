...
<html lang="en">
    <head>
        ...
        <title>DivSec | Division List</title>
            ...
            <div>
                ...
                <div class="inner">
                    <div class="row hidden-print">
                        <div class="col-lg-12">
                            <h3 class="text-info">Print Approvals Preview</h3>
                    ...
                    <div class="row hidden-print">
                        <div class="col-lg-12">
                            <ol class="breadcrumb">
                                ...
                                <li>Process</li>
                                <li><a href="${pageContext.request.contextPath}/batch-approval">Approval</a></li>
                                <li class="active">Print Approval</li>
                            </ol>
                        </div>
                    </div>
                    <!--End Bread Crumb -->
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="col-lg-2">
                                <button id="btnIdPrintThis" type="button" class="  btn  btn-block btn-primary hidden-print btn-sm" onclick="location.href = 'undoprinted';">
                                     <i class="icon-undo icon-white"></i> Undo Print
                                </button>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div id="divIdPrint" class="col-lg-12" >
    ...
    <script src="${pageContext.request.contextPath}/resources/js/divsec_print_approval.js"></script>
