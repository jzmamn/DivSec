                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    <div class="table-responsive">
                                        <table class="table table-striped table-bordered table-condensed table-hover" id="dtSubject">
                                            <thead>
                                                <tr>
                                                    <th style="width: 10%;">SubjectId</th>
                                                    <th>Code</th>
                                                    <th>Name</th>
                                                    <th>DivId</th>
                                                    <th>Division</th>
                                ...
                                <form:form role="form" id="frmIdSubject" method="POST" modelAttribute="maSubject" data-toggle="validator">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="col-lg-12 ">
                                                <div class="form-group">
                                                    <label for="txtIdSbjDuration" class="control-label">Duration(in days)</label>
