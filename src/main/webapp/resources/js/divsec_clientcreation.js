jQuery(function () {
    ...
    $('#txtIdDivisionId').val(6); // The division id 6 is dedicated for client in the database
    $('#txtIdCatId').val(4);//The Role id 4 is dedicated for ROLE_CLIENT in the database
    $('#txtIdCatName').val('ROLE_CLIENT');
    ...
    $('#dtUser tbody').on('click', 'tr', function (e) {
        ...
        $('#txtIdPublicName').val(dtUser.fnGetData(aPos, 1));
    ...
    $("#frmIdUser").submit(function () {
        ...
        $.ajax({
            ...
            success: function (res) {
                ...
                if (res == "1") {
                    dtUser.fnReloadAjax('createaccount/loaduser');
    ...
    $("#btnDelete").click(
            function (e) {
                ...
                var url = "createaccount/delete/" + staffId;
                // alert(url);
                swal({
                    title: "Are you sure?",
